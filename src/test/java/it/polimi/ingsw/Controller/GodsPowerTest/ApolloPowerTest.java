...
import it.polimi.ingsw.Network.Message.Requests.EndTurnRequest;
...
public class ApolloPowerTest {
    ...
    public void ApolloPower() {
        ...
        //tocca al player1
        //seleziona un worker...
        MasterController.dispatcher( new SelectWorkerRequest(pl1, w1pl1) );
        ...
        MasterController.dispatcher(new SelectWorkerRequest(pl2, w2pl2));
        game.getGameMap().printBoard();
